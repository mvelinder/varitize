...
vts[(vts['INFO_BCSQ'].str.contains('missense')) & ((vts['AlphaMissense'] >= '0.6') | (vts['REVEL'] >= '0.6') | (vts['EVE'] >= '0.6') | (vts['MutScore'] >= '0.6'))].to_csv(tsvin + '.missense.deleterious.tsv', sep='\t', index=False)

mvts = vts[(vts['INFO_BCSQ'].str.contains('missense')) & ((vts['AlphaMissense'] >= '0.6') | (vts['REVEL'] >= '0.6') | (vts['EVE'] >= '0.6') | (vts['MutScore'] >= '0.6'))]
